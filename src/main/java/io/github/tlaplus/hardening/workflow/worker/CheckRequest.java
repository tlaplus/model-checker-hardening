 ...
 * checked against it: TLC through its configuration, Apalache through {@code --temporal}. The
 * parser reads neither field.
 *
 ...
 */
public record CheckRequest(int transitions, boolean temporalProperty) {
    public CheckRequest {
    ...
    public static CheckRequest invariant(int transitions) {
        return new CheckRequest(transitions, false);
    }
