...
class IrGenerationConfigTest {
    private static final ExpressionLimits LIMITS = new ExpressionLimits(0, 1, 1, new CollectionLimits(1, 0, 4, 64), 0, 0);

    @Test
    void exposesDocumentedDefaults() {
        assertEquals(
                new IrGenerationConfig(
                        new ExpressionLimits(3, 32, 128, new CollectionLimits(8, 3, 4, 64), 32, 16),
    ...
    void rejectsInvalidExpressionLimits() {
        assertThrows(
                IllegalArgumentException.class, () -> new ExpressionLimits(-1, 1, 1, new CollectionLimits(1, 0, 4, 64), 0, 0));
        assertThrows(
                IllegalArgumentException.class, () -> new ExpressionLimits(0, 0, 1, new CollectionLimits(1, 0, 4, 64), 0, 0));
        assertThrows(
                IllegalArgumentException.class, () -> new ExpressionLimits(0, 1, 0, new CollectionLimits(1, 0, 4, 64), 0, 0));
        assertThrows(
                IllegalArgumentException.class, () -> new ExpressionLimits(0, 1, 1, new CollectionLimits(0, 0, 4, 64), 0, 0));
        assertThrows(
                IllegalArgumentException.class, () -> new ExpressionLimits(0, 1, 1, new CollectionLimits(1, 0, 4, 64), -1, 0));
        assertThrows(
                IllegalArgumentException.class, () -> new ExpressionLimits(0, 1, 1, new CollectionLimits(1, 0, 4, 64), 0, -1));
    }
    ...
    void rejectsInvalidModuleLimits() {
        assertThrows(IllegalArgumentException.class, () -> new ModuleLimits(0, 0, ActionLimits.defaults(), 0, 0));
        assertThrows(IllegalArgumentException.class, () -> new ModuleLimits(1, -1, ActionLimits.defaults(), 0, 0));
        assertThrows(IllegalArgumentException.class, () -> new ModuleLimits(1, 0, ActionLimits.defaults(), -1, 0));
        assertThrows(NullPointerException.class, () -> new ModuleLimits(1, 0, null, 0, 0));
