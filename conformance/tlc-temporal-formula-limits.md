...
corpus33 12 and corpus35 13, all of the label row below. SANY accepted all of them. corpus29's four `cannot handle` crashes are all the row with a
...
bare; the corpus30 crashes were not classified by shape row.
